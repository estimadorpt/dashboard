...
console.error("[Loader Start] seat_forecast.json.js - Top Level");
try {
  const filePath = "src/data/sample_seat_forecast.json";
  ...
  if (!jsonContent || jsonContent.trim() === "") {
    ...
    console.error("[Loader Error] seat_forecast.json.js:", error);
    process.exit(1);
}
console.error("[Loader End] seat_forecast.json.js - Top Level"); 